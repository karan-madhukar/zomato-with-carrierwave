class RestaurantsController < ApplicationController
  ...
  def restaurant_params
    params.require(:restaurant).permit(:restaurant_name, :address, :email, :phone_no, :table_price, :image, :restaurant_category_id, restaurant_image: [], food_image: [], menu_image: [])
  end
