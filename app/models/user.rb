class User < ApplicationRecord
  ...
  validates :password, presence: true, length: { maximum:20 , minimum: 6 }, on: :create
  validates :Username, presence: true, format: { with:  VALID_NAME_REGEX }, length: { maximum: 35, minimum: 2}
