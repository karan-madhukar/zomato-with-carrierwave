...
RSpec.describe Restaurant, type: :model do
  ...
  describe ".restaurant_name_format" do
    ...
    context "with not valid format of restaurantname" do
      it "restaurant containg name with digits and special characters is invalid" do
        subject.restaurant_name = "karan123"
        expect(subject).not_to be_valid
      end
    end
  end
  ...
  describe ".restaurant_email_uniqueness" do
    let(:restaurant_duplicate) { Restaurant.new(restaurant_name: "person", email: "personx@gmail.com", address: "some unkown address", phone_no: "9852123456", table_price: 560.6, restaurant_category_id: 1 ) }
  ...
  describe "belongs_to :restaurant_category" do
